...
Begin VB.Form frmOptions 
   ...
   Begin prjDownloadBooster.ImageList imgFiles 
      ...
      ColorDepth      =   4
      MaskColor       =   16711935
      InitListImages  =   "frmOptions.frx":2202
   End
End
...
Private Sub Form_Load()
    ...
    cbWhenExist.AddItem t("자동 이름 바꾸기", "Auto Rename")
