...
Else
    ...
    Else
        If ListViewDesignMode = True Then
            'VBA.VBA.MsgBox "Invalid property Value", vbCritical + vbOKOnly
            Exit Property
        Else
            Err.Raise 380
        End If
...
Select Case Value
    Case LvwViewIcon, LvwViewSmallIcon, LvwViewList, LvwViewReport, LvwViewTile
        If PropVirtualMode = True And Value = LvwViewTile Then
            If ListViewDesignMode = True Then
                'VBA.VBA.MsgBox "View must not be 4 - Tile when VirtualMode is True", vbCritical + vbOKOnly
                Exit Property
            Else
...
Select Case Value
    Case LvwArrangeNone, LvwArrangeAutoLeft, LvwArrangeAutoTop, LvwArrangeLeft, LvwArrangeTop
        If PropVirtualMode = True And Value <> LvwArrangeNone Then
            If ListViewDesignMode = True Then
                'VBA.VBA.MsgBox "Arrange must be 0 - None when VirtualMode is True", vbCritical + vbOKOnly
                Exit Property
            Else
...
If PropVirtualMode = True And Value = True Then
    If ListViewDesignMode = True Then
        'VBA.VBA.MsgBox "GroupView must be False when VirtualMode is True", vbCritical + vbOKOnly
        Exit Property
    Else
    ...
    Case WM_UNICHAR
        ...
        Else
            ...
            ElseIf Len(UTF16) = 2 Then
                ...
                SendMessage hWnd, WM_CHAR, CIntToUInt(AscW(VBA.VBA.Right$(UTF16, 1))), ByVal lParam
            End If
            WindowProcControl = 0
        End If
        Exit Function
