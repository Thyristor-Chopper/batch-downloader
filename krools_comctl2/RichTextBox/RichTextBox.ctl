...
If PropOLEDragDropRTF = True And Value = vbOLEDragAutomatic Then
    If RichTextBoxDesignMode = True Then
        VBA.MsgBox "OLEDragMode must be 0 - Manual when OLEDragDropRTF is True", vbCritical + vbOKOnly
        Exit Property
    Else
...
If PropOLEDragDropRTF = True And Value = False Then
    If RichTextBoxDesignMode = True Then
        VBA.MsgBox "OLEDragDropScroll must be True when OLEDragDropRTF is True", vbCritical + vbOKOnly
        Exit Property
    Else
...
If PropOLEDragDropRTF = True And Value = OLEDropModeManual Then
    If RichTextBoxDesignMode = True Then
        VBA.MsgBox "OLEDropMode must be 0 - None when OLEDragDropRTF is True", vbCritical + vbOKOnly
        Exit Property
    Else
...
Else
    ...
    Else
        If RichTextBoxDesignMode = True Then
            VBA.MsgBox "The specified file name cannot be accessed or is invalid.", vbCritical + vbOKOnly
            Exit Property
        Else
