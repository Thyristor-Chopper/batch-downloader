        ...
        Case vbObject
            ...
            If Success = True Then
                ...
                Else
                    ...
                    If ToolBarDesignMode = True Then
                        VBA.MsgBox "ImageList Image sizes must be the same", vbCritical + vbOKOnly
                        Exit Property
                    Else
        ...
        Select Case Align
            Case vbAlignTop, vbAlignBottom
                If Value <> TbrOrientationHorizontal Then
                    If ToolBarDesignMode = True Then
                        VBA.MsgBox "Orientation must be 0 - Horizontal when Align is 1 - AlignTop or 2 - AlignBottom", vbCritical + vbOKOnly
                        Exit Property
                    Else
            ...
            Case vbAlignLeft, vbAlignRight
                If Value <> TbrOrientationVertical Then
                    If ToolBarDesignMode = True Then
                        VBA.MsgBox "Orientation must be 1 - Vertical when Align is 3 - AlignLeft or 4 - AlignRight", vbCritical + vbOKOnly
                        Exit Property
                    Else
...
If Value > 1 And PropTextAlignment = TbrTextAlignRight Then
    If ToolBarDesignMode = True Then
        VBA.MsgBox "MaxTextRows must not be higher than 1 when TextAlignment is 1 - TextAlignRight", vbCritical + vbOKOnly
        Exit Property
    Else
