...
Private Sub Form_Unload(Cancel As Integer)
    If cmdYes.Visible And cmdNo.Visible And (Not cmdCancel.Visible) And (Not ButtonPressed) Then
        ...
        Exit Sub
    End If
    If Not ButtonPressed Then Functions.MsgBoxResult = vbCancel
