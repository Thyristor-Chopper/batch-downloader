...
'Dim WithEvents tygButton As TygemButton
...
'End If
If CommandButtonHandle <> NULL_PTR Then
    MoveWindow CommandButtonHandle, IIf(PropIsTygemButton And False, UserControl.ScaleWidth + 5, 0), IIf(PropIsTygemButton And False, UserControl.ScaleHeight + 5, 0), UserControl.ScaleWidth, UserControl.ScaleHeight, IIf(PropTransparent, 0, 1)
End If
End With
Call CreateCommandButton
...
If CommandButtonHandle <> NULL_PTR Then
    If PropTransparent = True Then
        MoveWindow CommandButtonHandle, IIf(PropIsTygemButton And False, .ScaleWidth + 5, 0), IIf(PropIsTygemButton And False, .ScaleHeight + 5, 0), .ScaleWidth, .ScaleHeight, 0
...
exitif:
    Else
        MoveWindow CommandButtonHandle, IIf(PropIsTygemButton And False, .ScaleWidth + 5, 0), IIf(PropIsTygemButton And False, .ScaleHeight + 5, 0), .ScaleWidth, .ScaleHeight, 1
    End If
End If
End With
InProc = False
...
IsTygemButton = False 'PropIsTygemButton
End Property
...
CommandButtonHandle = CreateWindowEx(dwExStyle, StrPtr("Button"), NULL_PTR, dwStyle, IIf(PropIsTygemButton And False, UserControl.ScaleWidth + 5, 0), IIf(PropIsTygemButton And False, UserControl.ScaleHeight + 5, 0), UserControl.ScaleWidth, UserControl.ScaleHeight, UserControl.hWnd, NULL_PTR, App.hInstance, ByVal NULL_PTR)
If CommandButtonHandle <> NULL_PTR Then
